...
struct	pentry	{
	...
	int	pwaitret;
	int time_spent_syscall[27];     /* records the toal time spent for executing each system calls */
	int counter_for_syscall[27];    /* records the number of times each system call is invoked */
};
...
int syscall_flag;                       /* system call flag set */
#endif
